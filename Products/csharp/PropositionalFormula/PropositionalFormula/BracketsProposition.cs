...
{
    public class BracketsProposition : UnaryOperator
    {
        public BracketsProposition(PropositionalFormula formula) : base(formula)
        {
            formType = FormType.Brackets;
        }
        ...
        public override string ToString()
        {
            ...
            {
                return StrBracketOpen + _innerFormula.ToString();
            }
            else
            {
