...
{
    public class ImplicationProposition : BinaryOperator
    {
        public ImplicationProposition(PropositionalFormula first, PropositionalFormula second) : base(first, second)
        {
            formType = FormType.Implication;
        }
        ...
        public override string ToString()
        {
            ...
            {
                return _firstFormula.ToString() + StrImplication + _secondFormula.ToString();
            }
            else
            {
